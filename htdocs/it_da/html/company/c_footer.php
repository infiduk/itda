<!-- footer -->
	<div class="footer">
		<div class="col-md-5 footer-left-agileits">
			<h3>Address</h3>
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 서울특별시 노원구 월계동 초안산로 12</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@example.com">it_da@induk.ac.kr</a></li>
