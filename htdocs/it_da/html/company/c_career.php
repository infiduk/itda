...
<!-- 테이블 시작 -->
	<table class="table  table-bordered  table-sm  mymargin5" width="300" align="center">
		<tr class="mycolor2" bgcolor='#F2F2F2'>
			...
			<td width="20%" align="center"><b>부서명 / 직급</b></td>
			<td width="20%" align="center"><b>내용</b></td>
			<td width="15%" align="center"><b>근무기간</b></td>
	...
	<?
		for($i=1;$i<$count+1;$i++){
			...
			list($type,$a,$b,$c,$d,$e)=explode("#",$row[information]);
			if($type==1){
				echo("
					<tr>
