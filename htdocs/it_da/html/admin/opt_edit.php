...
<input type="hidden" name="no1" value="<?=$row[no22];?>">
...
<table width="500" border="1" cellpadding="2" style="border-collapse:collapse">
	<tr> 
		...
		<td width="400" height="20"  bgcolor="#F2F2F2"><?=$row[no22];?></td>
	</tr>
	<tr> 
		<td width="100" height="20" bgcolor="#CCCCCC" align="center">
		...
		<td width="400" height="20"  bgcolor="#F2F2F2">
			<input type="text" name="name" value="<?=$row[name22];?>" size="20" maxlength="20">
		</td>
	</tr>
</table>
<br>
